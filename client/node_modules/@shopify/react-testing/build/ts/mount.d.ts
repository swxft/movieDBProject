...
export interface CustomMount<MountOptions extends object, Context extends object, Async extends boolean> {
    <Props>(...args: IfAllOptionalKeys<MountOptions, [React.ReactElement<any>, MountOptions?], [React.ReactElement<any>, MountOptions]>): CustomMountResult<Props, Context, Async>;
