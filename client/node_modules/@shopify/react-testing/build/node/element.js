...
class Element {
  ...
  constructor(tree, allChildren, allDescendants, root) {
    this.tree = tree;
    this.allChildren = allChildren;
    this.root = root;
    this.elementChildren = void 0;
    this.elementDescendants = void 0;
    this.elementChildren = allChildren.filter(element => typeof element !== 'string');
    this.elementDescendants = allDescendants.filter(element => typeof element !== 'string');
  }
  ...
  toString() {
    return `<${(0, _toReactString.nodeName)(this)} />`;
  }
