...
export function toReactString(node) {
...
export function toPropString(key, value) {
  ...
  if (value instanceof Array) {
    return "".concat(key, "={").concat(stringify(value, verbosity + 1), "}");
  }

  return "".concat(key, "={").concat(stringify(value, verbosity), "}");
}
export function nodeName(_ref) {
  var type = _ref.type;
