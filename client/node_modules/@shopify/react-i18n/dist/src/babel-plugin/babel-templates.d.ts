...
export declare function i18nCallExpression(template: TemplateBuilder<Types.ImportDeclaration | Types.ObjectExpression>, { id, fallbackID, translationArrayID, bindingName, translationFilePaths, fallbackLocale, }: {
    id: any;
    fallbackID: any;
